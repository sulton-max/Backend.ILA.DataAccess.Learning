...
namespace EntityRelations.ApproachesA.Migrations
{
    ...
    [Migration("20231101124501_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityRelations.ApproachesA.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EntityRelations.ApproachesA.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EntityRelations.ApproachesA.Models.Book", b =>
                {
                    b.HasOne("EntityRelations.ApproachesA.Models.Author", null)
                        .WithMany()
